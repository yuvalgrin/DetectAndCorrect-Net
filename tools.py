...
def dataset_split(train_images, train_labels, noise_rate=0.5, split_per=0.9, random_seed=1, num_classes=10, noise_type='symmetric'):
    ...
    saved_clean_train_labels = clean_train_labels.copy()
    ...
    train_set_index = [idx for idx in range(int(num_samples*split_per))]
    ...
    return train_set, val_set, train_labels, val_labels, transition_matrix, saved_clean_train_labels[train_set_index].squeeze()
